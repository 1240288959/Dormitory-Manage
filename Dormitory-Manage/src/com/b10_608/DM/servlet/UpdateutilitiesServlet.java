...
/**
 * Servlet implementation class UpdateutilitiesServlet
 */
@WebServlet("/Updateutilities")
public class UpdateutilitiesServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sql="update utilities set dno = ?,month = ?,wcost = ? ,ecost = ? where uno = ?";
	    ...
	    try {
			...
			if(flag==false)
				...
				out.print(0);
			System.out.println("updateutilities :"+flag);
