...
/**
 * Servlet implementation class UpdatemechineServlet
 */
@WebServlet("/Updatemechine")
public class UpdatemechineServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sql="update mechine set mname = ?,sdate = ?,fdate = ?,cost = ? where mno = ?";
	    ...
	    try {
			...
			if(flag==false)
				...
				out.print(0);
			System.out.println("updatemechine :"+flag);
