...
/**
 * Servlet implementation class AdddormitoryServlet
 */
@WebServlet("/Adddormitory")
public class AdddormitoryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sql="insert into dormitory(dname,dphone,maxpeople,nowpeople) values(?,?,?,?)";
	    ...
	    try {
			...
			if(flag==false)
				...
				out.print(0);
			System.out.println("adddormitory :"+flag);
