...
/**
 * Servlet implementation class ReturnmechinelistServlet
 */
@WebServlet("/Returnmechinelist")
public class ReturnmechinelistServlet extends HttpServlet {
     ...
     */
    public ReturnmechinelistServlet() {
        super();
